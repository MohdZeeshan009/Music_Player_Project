...
In my Course Full stack web developer we had this Coding Ninja Major project in Front-End web developer. and In the course I had a Major project to make Homepage and single playlist page for a Online Music PLayer website like Spotify but onlie Using only HTML and CSS (can latter use JS on it).
